...
- Always use labeled buttons or accessible roles (e.g., "Create", "Edit", "Publish") — avoid coordinates
...
3. Select Project (user-provided name)
4. Select Issue Type (Task, Story, Bug)
5. Fill Summary and Description
6. Click Create
7. Wait for success toast with issue key (e.g., ENG-123)
...
5. Capture details (title, status, assignee)

UPDATE ISSUE FIELDS:
1. Open issue view
2. Click Status field → choose new status
3. For Assignee: click and type new name
4. For Description: click editor, update, click Save/Update
...
TRANSITION WORKFLOW:
1. Open issue
2. Click Status chip/button
3. Choose next workflow step (Done, Review, etc.)
...
2. Select "Blank page" or Template
3. Fill Title and Body content
4. Use slash commands for structure (/Table, /Panel)
5. Click "Publish"
...
5. Capture URL and metadata (title, author, last updated)
...
EXTRACT/SUMMARIZE:
1. Locate main content block (<div id="content"> or role="main")
2. Extract visible text
3. Summarize key sections (headings, bullets, tables)`
  },
  {
    id: 'default-workday',
